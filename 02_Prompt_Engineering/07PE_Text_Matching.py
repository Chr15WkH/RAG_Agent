...
questions = [
    ...
    ("油价大幅度下降，能源公司面临挑战。", "未来智能城市的建设趋势愈加明显。"),
    ("股票市场今日大涨，投资者乐观。", "持续上涨的市场让投资者感到满意。")
]

messages = [
    {"role":"system", "content":"你帮我完成文本匹配，我给你两个句子，被[]所包围，你判断他们是否匹配，回答是或不是，请参考如下示例。"}
]
...
for question in questions:
    response = client.chat.completions.create(
        model = "qwen3-max",
        messages = messages + [{"role":"user", "content":f"按照上述示例，回答这两个句子的情况。句子1:[{question[0]}], 句子2:[{question[1]}]"}]
    )
